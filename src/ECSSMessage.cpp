...
void ECSSMessage::appendByte(uint8_t value) {
	ASSERT_INTERNAL(dataSize < ECSSMaxMessageSize, ErrorHandler::MessageTooLarge);
...
void ECSSMessage::appendHalfword(uint16_t value) {
...
void ECSSMessage::appendWord(uint32_t value) {
...
uint16_t ECSSMessage::readBits(uint8_t numBits) {
...
uint16_t ECSSMessage::readHalfword() {
