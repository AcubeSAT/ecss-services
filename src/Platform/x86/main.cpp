...
int main() {
	...
	ECSSMessage packet = ECSSMessage(0, 0, ECSSMessage::TC, 1);
	...
	ECSSMessage receivedPacket =
	    ECSSMessage(TestService::ServiceType, TestService::MessageType::AreYouAliveTest, ECSSMessage::TC, 1);
	testService.areYouAlive(receivedPacket);
	receivedPacket = ECSSMessage(TestService::ServiceType, TestService::MessageType::OnBoardConnectionTest, ECSSMessage::TC, 1);
	...
	ECSSMessage sentPacket = ECSSMessage(ParameterService::ServiceType, ParameterService::MessageType::ReportParameterValues,
	                                     ECSSMessage::TC, 1); // application id is a dummy number (1)
	...
	ECSSMessage sentPacket2 = ECSSMessage(ParameterService::ServiceType, ParameterService::MessageType::SetParameterValues,
	                                      ECSSMessage::TC, 1); // application id is a dummy number (1)
	...
	*(pStr + 2) = 0;
	...
	ECSSMessage rcvPack = ECSSMessage(MemoryManagementService::ServiceType,
	                          MemoryManagementService::MessageType::DumpRawMemoryData, ECSSMessage::TC, 1);
	...
	rcvPack = ECSSMessage(MemoryManagementService::ServiceType,
	                  MemoryManagementService::MessageType::LoadRawMemoryDataAreas, ECSSMessage::TC, 1);
	...
	rcvPack = ECSSMessage(MemoryManagementService::ServiceType, MemoryManagementService::MessageType::CheckRawMemoryData,
	                      ECSSMessage::TC, 1);
	...
	ECSSMessage receivedMessage =
	    ECSSMessage(RequestVerificationService::ServiceType,
	            RequestVerificationService::MessageType::SuccessfulAcceptanceReport, ECSSMessage::TC, 3);
	reqVerifService.successAcceptanceVerification(receivedMessage);

	receivedMessage = ECSSMessage(RequestVerificationService::ServiceType,
	                          RequestVerificationService::MessageType::FailedAcceptanceReport, ECSSMessage::TC, 3);
	reqVerifService.failAcceptanceVerification(receivedMessage, ErrorHandler::UnknownAcceptanceError);

	receivedMessage = ECSSMessage(RequestVerificationService::ServiceType,
	                          RequestVerificationService::MessageType::SuccessfulStartOfExecution, ECSSMessage::TC, 3);
	reqVerifService.successStartExecutionVerification(receivedMessage);

	receivedMessage = ECSSMessage(RequestVerificationService::ServiceType,
	                          RequestVerificationService::MessageType::FailedStartOfExecution, ECSSMessage::TC, 3);
	reqVerifService.failStartExecutionVerification(receivedMessage, ErrorHandler::UnknownExecutionStartError);

	receivedMessage = ECSSMessage(RequestVerificationService::ServiceType,
	                          RequestVerificationService::MessageType::SuccessfulProgressOfExecution, ECSSMessage::TC, 3);
	reqVerifService.successProgressExecutionVerification(receivedMessage, 0);

	receivedMessage = ECSSMessage(RequestVerificationService::ServiceType,
	                          RequestVerificationService::MessageType::FailedProgressOfExecution, ECSSMessage::TC, 3);
	reqVerifService.failProgressExecutionVerification(receivedMessage, ErrorHandler::UnknownExecutionProgressError, 0);

	receivedMessage = ECSSMessage(RequestVerificationService::ServiceType,
	                          RequestVerificationService::MessageType::SuccessfulCompletionOfExecution, ECSSMessage::TC, 3);
	reqVerifService.successCompletionExecutionVerification(receivedMessage);

	receivedMessage = ECSSMessage(RequestVerificationService::ServiceType,
	                          RequestVerificationService::MessageType::FailedCompletionOfExecution, ECSSMessage::TC, 3);
	reqVerifService.failCompletionExecutionVerification(receivedMessage, ErrorHandler::UnknownExecutionCompletionError);

	receivedMessage = ECSSMessage(RequestVerificationService::ServiceType,
	                          RequestVerificationService::MessageType::FailedRoutingReport, ECSSMessage::TC, 3);
	...
	ECSSMessage trivialMessage = ECSSMessage();
	...
	ECSSMessage errorMessage(0, 0, ECSSMessage::TC, 1);
	...
	ECSSMessage eventMessage(EventReportService::ServiceType,
	                     EventReportService::MessageType::DisableReportGenerationOfEvents, ECSSMessage::TC, 1);
	eventMessage.appendUint16(2);
	eventMessage.appendEnum16(eventIDs[0]);
	eventMessage.appendEnum16(eventIDs[1]);

	ECSSMessage eventMessage2(EventReportService::ServiceType,
	                      EventReportService::MessageType::EnableReportGenerationOfEvents, ECSSMessage::TC, 1);
	eventMessage2.appendUint16(1);
	eventMessage2.appendEnum16(eventIDs2[0]);

	ECSSMessage eventMessage3(EventReportService::ServiceType, EventReportService::MessageType::ReportListOfDisabledEvents,
	                          ECSSMessage::TC, 1);
	...
	ECSSMessage eventActionDefinition(EventActionService::ServiceType, EventActionService::MessageType::AddEventAction,
	                                  ECSSMessage::TC, 1);
	...
	ECSSMessage eventActionDefinition1(EventActionService::ServiceType, EventActionService::MessageType::AddEventAction,
	                                   ECSSMessage::TC, 1);
	...
	ECSSMessage eventActionDefinition2(EventActionService::ServiceType, EventActionService::MessageType::AddEventAction,
	                                   ECSSMessage::TC, 1);
	...
	ECSSMessage eventActionDefinition7(EventActionService::ServiceType, EventActionService::MessageType::AddEventAction,
	                                   ECSSMessage::TC, 1);
	...
	ECSSMessage eventActionDefinition5(EventActionService::ServiceType, EventActionService::MessageType::EnableEventAction,
	                                   ECSSMessage::TC, 1);
	...
	ECSSMessage eventActionDefinition3(EventActionService::ServiceType, EventActionService::MessageType::DisableEventAction,
	                                   ECSSMessage::TC, 1);
	...
	ECSSMessage eventActionDefinition4(EventActionService::ServiceType, EventActionService::MessageType::DeleteEventAction,
	                                   ECSSMessage::TC, 1);
	...
	ECSSMessage eventActionDefinition6(EventActionService::ServiceType, EventActionService::MessageType::DisableEventAction,
	                                   ECSSMessage::TC, 1);
	...
	ECSSMessage receivedMsg =
	    ECSSMessage(TimeBasedSchedulingService::ServiceType,
	            TimeBasedSchedulingService::MessageType::EnableTimeBasedScheduleExecutionFunction, ECSSMessage::TC, 1);
	ECSSMessage testMessage1(6, 5, ECSSMessage::TC, 1);
	ECSSMessage testMessage2(4, 5, ECSSMessage::TC, 1);
	...
	receivedMsg = ECSSMessage(TimeBasedSchedulingService::ServiceType,
	                      TimeBasedSchedulingService::MessageType::InsertActivities, ECSSMessage::TC, 1);
	...
	receivedMsg = ECSSMessage(TimeBasedSchedulingService::ServiceType,
	                      TimeBasedSchedulingService::MessageType::TimeShiftALlScheduledActivities, ECSSMessage::TC, 1);
	...
	receivedMsg = ECSSMessage(TimeBasedSchedulingService::ServiceType,
	                      TimeBasedSchedulingService::MessageType::DetailReportAllScheduledActivities, ECSSMessage::TC, 1);
	timeBasedSchedulingService.detailReportAllActivities(receivedMsg);

	// Report the activities by ID
	receivedMsg = ECSSMessage(TimeBasedSchedulingService::ServiceType,
	                      TimeBasedSchedulingService::MessageType::ActivitiesSummaryReportById, ECSSMessage::TC, 1);
