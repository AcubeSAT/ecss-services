...
int main() {
	ParameterStatisticsService statisticsService;

	uint16_t parameterId = 7;
	uint16_t numOfSamples = 5;

	for (int i = 0; i < numOfSamples; i++) {
		statisticsService.statisticsMap[parameterId].updateStatistics(i);
	}
	...
	statisticsService.execute(request);
