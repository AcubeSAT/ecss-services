...
namespace AllReportTypes {
	const ServiceDefinitionsVector ST01Reports = {
	...
	const ServiceDefinitionsVector ST05Reports = {
	...
	const ServiceDefinitionsVector ST06Reports = {
		MemoryManagementService::MessageType::CheckRawMemoryDataReport,
		MemoryManagementService::MessageType::DumpRawMemoryDataReport,
		MemoryManagementService::MessageType::DumpedObjectMemoryDataReport
	};

	const ServiceDefinitionsVector ST11Reports = {
		TimeBasedSchedulingService::MessageType::TimeBasedScheduledSummaryReport
	};

	const ServiceDefinitionsVector ST13Reports = {
	...
	const ServiceDefinitionsVector ST17Reports = {
