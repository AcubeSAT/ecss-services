...
TEST_CASE("TC message parsing", "[MessageParser]") {
	etl::array<uint8_t, CCSDSMaxMessageSize> packet = {0x18, 0x07, 0xe0, 0x07, 0x00, 0x0a, 0x20, 0x81, 0x1f, 0x00, 0x00, 0x68, 0x65, 0x6c, 0x6c, 0x6f};
...
TEST_CASE("TM message parsing", "[MessageParser]") {
	etl::array<uint8_t, CCSDSMaxMessageSize> packet = {0x08, 0x02, 0xc0, 0x4d, 0x00, 0x12, 0x20, 0x16,
