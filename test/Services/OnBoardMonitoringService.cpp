...
TEST_CASE("Add Parameter Monitoring Definitions") {
	SECTION("Valid Request to add Parameter Monitoring Definitions") {
		...
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[1]).get().repetitionCounter == 0);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[2]).get().repetitionCounter == 0);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[0]).get().repetitionNumber == repetitionNumbers[0]);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[1]).get().repetitionNumber == repetitionNumbers[1]);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[2]).get().repetitionNumber == repetitionNumbers[2]);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[0]).get().monitoringEnabled == false);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[1]).get().monitoringEnabled == false);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[2]).get().monitoringEnabled == false);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[0]).get().checkType == PMONBase::ExpectedValueCheck);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[1]).get().checkType == PMONBase::LimitCheck);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[2]).get().checkType == PMONBase::DeltaCheck);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[0]).get().checkingStatus == PMONBase::Unchecked);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[1]).get().checkingStatus == PMONBase::Unchecked);
		CHECK(onBoardMonitoringService.getPMONDefinition(PMONIds[2]).get().checkingStatus == PMONBase::Unchecked);
...
//		CHECK(report.readEnum16() == onBoardMonitoringService.MonitoredParameterIds.at(PMONIds[1]));
//		CHECK(report.readEnum8() == onBoardMonitoringService.ParameterMonitoringStatus.at(PMONIds[1]));
//		CHECK(report.readEnum16() == onBoardMonitoringService.RepetitionNumber.at(PMONIds[1]));
//		CHECK(report.readEnum8() == onBoardMonitoringService.LimitCheck);
//		CHECK(report.readUint16() == onBoardMonitoringService.LimitCheckParameters.at(PMONIds[1]).lowLimit);
//		CHECK(report.readEnum8() == onBoardMonitoringService.LimitCheckParameters.at(PMONIds[1]).belowLowLimitEvent);
//		CHECK(report.readUint16() == onBoardMonitoringService.LimitCheckParameters.at(PMONIds[1]).highLimit);
//		CHECK(report.readEnum8() ==
//		      onBoardMonitoringService.LimitCheckParameters.at(PMONIds[1]).aboveHighLimitEvent);
//		CHECK(report.readEnum16() == PMONIds[2]);
//		CHECK(report.readEnum16() == onBoardMonitoringService.MonitoredParameterIds.at(PMONIds[2]));
//		CHECK(report.readEnum8() == onBoardMonitoringService.ParameterMonitoringStatus.at(PMONIds[2]));
//		CHECK(report.readEnum16() == onBoardMonitoringService.RepetitionNumber.at(PMONIds[2]));
//		CHECK(report.readEnum8() == onBoardMonitoringService.DeltaCheck);
//		CHECK(report.readUint16() == onBoardMonitoringService.DeltaCheckParameters.at(PMONIds[2]).lowDeltaThreshold);
//		CHECK(report.readEnum8() ==
//		      onBoardMonitoringService.DeltaCheckParameters.at(PMONIds[2]).belowLowThresholdEvent);
//		CHECK(report.readUint16() ==
//		      onBoardMonitoringService.DeltaCheckParameters.at(PMONIds[2]).highDeltaThreshold);
//		CHECK(report.readEnum8() ==
//		      onBoardMonitoringService.DeltaCheckParameters.at(PMONIds[2]).aboveHighThresholdEvent);
//		CHECK(report.readUint16() ==
//		      onBoardMonitoringService.DeltaCheckParameters.at(PMONIds[2]).numberOfConsecutiveDeltaChecks);
//		clearAllMaps();
//		ServiceTests::reset();
//		Services.reset();
//	}
