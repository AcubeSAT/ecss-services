...
TEST_CASE("Add event-action definitions TC[19,1]", "[service][st19]") {
	...
	ECSSMessage message(EventActionService::ServiceType, EventActionService::MessageType::AddEventAction, ECSSMessage::TC, 0);
	...
	ECSSMessage message1(EventActionService::ServiceType, EventActionService::MessageType::AddEventAction, ECSSMessage::TC, 0);
	...
	ECSSMessage message2(EventActionService::ServiceType, EventActionService::MessageType::AddEventAction, ECSSMessage::TC, 0);
	...
	ECSSMessage message3(EventActionService::ServiceType, EventActionService::MessageType::AddEventAction, ECSSMessage::TC, 0);
...
TEST_CASE("Delete event-action definitions TC[19,2]", "[service][st19]") {
	...
	ECSSMessage message0(EventActionService::ServiceType, EventActionService::MessageType::AddEventAction, ECSSMessage::TC, 0);
	...
	ECSSMessage message5(EventActionService::ServiceType, EventActionService::MessageType::DeleteEventAction, ECSSMessage::TC, 0);
	...
	ECSSMessage message8(EventActionService::ServiceType, EventActionService::MessageType::EnableEventAction, ECSSMessage::TC, 0);
	...
	ECSSMessage message6(EventActionService::ServiceType, EventActionService::MessageType::DeleteEventAction, ECSSMessage::TC, 0);
	...
	ECSSMessage message7(EventActionService::ServiceType, EventActionService::MessageType::DeleteEventAction, ECSSMessage::TC, 0);
	...
	ECSSMessage message9(EventActionService::ServiceType, EventActionService::MessageType::DeleteEventAction, ECSSMessage::TC, 0);
...
TEST_CASE("Delete all event-action definitions TC[19,3]", "[service][st19]") {
	...
	ECSSMessage message4(EventActionService::ServiceType, EventActionService::MessageType::AddEventAction, ECSSMessage::TC, 0);
	...
	ECSSMessage message(EventActionService::ServiceType, EventActionService::MessageType::DeleteAllEventAction, ECSSMessage::TC, 0);
	MessageParser::execute(message);
...
TEST_CASE("Enable event-action definitions TC[19,4]", "[service][st19]") {
	...
	ECSSMessage message3(EventActionService::ServiceType, EventActionService::MessageType::EnableEventAction, ECSSMessage::TC, 0);
	...
	ECSSMessage message7(EventActionService::ServiceType, EventActionService::MessageType::EnableEventAction, ECSSMessage::TC, 0);
	message7.appendUint16(1);
	message7.appendEnum16(1);
...
TEST_CASE("Disable event-action definitions TC[19,5]", "[service][st19]") {
	...
	// Creating a message to enable the previous messages
	ECSSMessage message4(EventActionService::ServiceType, EventActionService::MessageType::DisableEventAction, ECSSMessage::TC, 0);
	...
	// Checking for errors in the case of an attempt to enable an unknown definition
	ECSSMessage message7(EventActionService::ServiceType, EventActionService::MessageType::DisableEventAction, ECSSMessage::TC, 0);
	message7.appendUint16(1);
	message7.appendEnum16(1);
	message7.appendEnum16(6);
	MessageParser::execute(message7);
	...
	// Checking for errors in the case of an attempt to enable an unknown definition
	ECSSMessage message8(EventActionService::ServiceType, EventActionService::MessageType::DisableEventAction, ECSSMessage::TC, 0);
	message8.appendUint16(1);
	message8.appendEnum16(1);
	message8.appendEnum16(1);
	message8.appendEnum16(10);
...
TEST_CASE("Request event-action definition status TC[19,6]", "[service][st19]") {
	...
	ECSSMessage message(EventActionService::ServiceType, EventActionService::MessageType::ReportStatusOfEachEventAction, ECSSMessage::TC, 0);
	MessageParser::execute(message);
...
TEST_CASE("Event-action status report TM[19,7]", "[service][st19]") {
	...
	ECSSMessage message2(EventActionService::ServiceType, EventActionService::MessageType::EnableEventAction, ECSSMessage::TC, 0);
...
TEST_CASE("Enable event-action function TC[19,8]", "[service][st19]") {
	...
	ECSSMessage message(EventActionService::ServiceType, EventActionService::MessageType::EnableEventActionFunction, ECSSMessage::TC, 0);
...
TEST_CASE("Disable event-action function TC[19,9]", "[service][st19]") {
	...
	ECSSMessage message(EventActionService::ServiceType, EventActionService::MessageType::DisableEventActionFunction, ECSSMessage::TC, 0);
