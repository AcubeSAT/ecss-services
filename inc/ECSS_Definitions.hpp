 ...
 */
inline constexpr uint16_t CCSDSPrimaryHeaderSize = 6U;
 ...
 */
inline constexpr uint16_t ECSSSecondaryTCHeaderSize = 5U;

/**
 * The maximum size of a regular ECSS message, plus its headers and trailing data, in bytes
 */
inline constexpr uint16_t CCSDSMaxMessageSize = ECSSMaxMessageSize + CCSDSPrimaryHeaderSize + ECSSSecondaryTMHeaderSize + 2U;
 ...
 */
inline constexpr uint16_t ECSSMaxStringSize = 256U;
 ...
 */
inline constexpr uint8_t ECSSMaxRequestCount = 20;
 ...
 */
inline constexpr uint8_t ECSSTCRequestStringSize = 64;
 ...
 */
inline constexpr uint16_t ECSSEventActionStructMapSize = 100;

/**
 * The maximum delta between the specified release time and the actual release time
 * @see TimeBasedSchedulingService
 */
inline constexpr uint8_t ECSSMaxDeltaOfReleaseTime = 60;

/**
 * The max number of simply commutated parameters per housekeeping structure in ST[03]
 */
inline constexpr uint16_t ECSSMaxSimplyCommutatedParameters = 30;
 ...
 */
inline constexpr uint8_t ECSSFunctionNameLength = 32;
 ...
 */
inline constexpr uint8_t ECSSMaxControlledApplicationProcesses = 5;
 ...
 */
inline constexpr uint8_t ECSSMaxApplicationsServicesCombinations = ECSSMaxControlledApplicationProcesses *
 ...
 * @see RealTimeForwardingControlService
 */
inline constexpr uint8_t ECSSMaxEventDefinitionIDs = 15;
 ...
 */
inline constexpr std::chrono::seconds ECSSCheckAllFrequency(60);
