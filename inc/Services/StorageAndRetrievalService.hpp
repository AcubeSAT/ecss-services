...
public:
	...
	private:
		 ...
		 */
		bool exceedsMaxServiceDefinitions(String<ECSS_MAX_PACKET_STORE_ID_SIZE>& packetStoreId, uint8_t applicationId,
		                                  Message& request);
		 ...
		 */
		bool noReportDefinitionInService(String<ECSS_MAX_PACKET_STORE_ID_SIZE>& packetStoreId, uint8_t applicationId,
		 ...
		 */
		bool checkApplicationForReportTypes(String<ECSS_MAX_PACKET_STORE_ID_SIZE>& packetStoreId, uint8_t applicationId,
		                                    Message& request);
		 ...
		 */
		bool checkService(String<ECSS_MAX_PACKET_STORE_ID_SIZE>& packetStoreId, uint8_t applicationId,
		                  uint8_t serviceId, Message& request);

		/**
		 * Creates a report type definition and adds it to the specified service definition.
		 */
		void addReportDefinition(const String<ECSS_MAX_PACKET_STORE_ID_SIZE>& packetStoreId, uint8_t applicationId,
		 ...
		 */
		int reportExistsInService(const String<ECSS_MAX_PACKET_STORE_ID_SIZE>& packetStoreId, uint8_t applicationId,
		                          uint8_t serviceId, uint8_t reportId);
		 ...
		 */
		bool serviceExistsInApp(const String<ECSS_MAX_PACKET_STORE_ID_SIZE>& packetStoreId, uint8_t applicationId,
		                        uint8_t serviceId);
		 ...
		 */
		void deleteEventDefinition(const String<ECSS_MAX_PACKET_STORE_ID_SIZE>& packetStoreId, uint8_t applicationId,
		                           uint16_t index);
	...
	public:
		 ...
		 */
		etl::vector<uint8_t, ECSS_MAX_CONTROLLED_APPLICATION_PROCESSES> controlledApplications;
