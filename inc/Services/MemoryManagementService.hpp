...
public:
	...
	public:
		...
		/**
		 * @brief Appends one dumped structured data instruction to a TM[6,4] report
		 ...
		 * @attention Given that the 6.6.4.5 section of the ECSS-E-ST-70-41C standard mentions that all of the
		 * instructions should be processed, even if there are faulty ones, the TM[6,4] might contain information
		 * such as offset = 0 and dataLength = 0. In that case, the next byte will be of the dumped data of the
		 * next instruction.
		 * @param request The TC[6,3] request, used to report any errors that occur
