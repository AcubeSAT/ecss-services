// TODO: Here implement parameter sample parsing with virtual functions
...
public:
	...
	// TODO: Calculation only requires sum, sum^2, min, max (doubles)

	explicit Statistic(const StatisticBase& base) {}
	DataType max = 0;   // TODO: make double
	DataType min = 0;
	uint32_t maxTime = 0;
	...
	etl::vector <DataType, SAMPLES_MAX_VECTOR_SIZE> samplesVector;  // TODO: delete and calculate when calling
	                                                              //       getValue, add this to Housekeeping
