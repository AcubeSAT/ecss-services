...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET etl::etl
                 ...
                 $<$<CONFIG:Release>:${etl_LINKER_FLAGS_RELEASE}>)
    set_property(TARGET etl::etl
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${etl_INCLUDE_DIRS_RELEASE}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET etl::etl
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${etl_LIB_DIRS_RELEASE}>)
    set_property(TARGET etl::etl
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${etl_COMPILE_DEFINITIONS_RELEASE}>)
    set_property(TARGET etl::etl
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${etl_COMPILE_OPTIONS_RELEASE}>)

########## For the modules (FindXXX)
set(etl_LIBRARIES_RELEASE etl::etl)
